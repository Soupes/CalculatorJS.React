...
class App extends React.Component{
  ...
  const response = await axios.post('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBbA4g5TevYumKu4na11AtIx35qXF2_zp8  ', authData)
...
if(response.data.idToken){
  ...
  const response = await axios.post('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBbA4g5TevYumKu4na11AtIx35qXF2_zp8', authData)
...
onChangeHandler = (event, controlName) =>{
  ...
  dataWrite = async () =>{
   ...
   await axios.post('https://rateapp-40c7f.firebaseio.com/sample.json', this.state.sample)
   .then((response)=>{
     return('')
   ...
   await axios('https://rateapp-40c7f.firebaseio.com/sample.json')
  ...
  sampleRemove =  async (id) =>{
    ...
    await axios.delete(`https://rateapp-40c7f.firebaseio.com/sample/${id}.json`)
  ...
  componentDidMount(){
    ...
    axios('https://rateapp-40c7f.firebaseio.com/sample.json')
